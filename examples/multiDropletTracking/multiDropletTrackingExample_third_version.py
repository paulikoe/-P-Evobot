...
path_file = '/Users/capo/Documents/data_from_exp/5Dec'
...
if number == 0:
    ...
    petridishCenter = (190, 170)  # 4
    # petridishCenter = (215, 220)  # 12 triton2cmc
    ...
    petridishCenter = (500, 180)  # 5 decanoate
    ...
    petridishCenter = (799, 180)  # 6 decanoate
    ...
    # x_center, y_center = (193, 154)
    petridishCenter = (1115, 180)  # 7
    x_center, y_center = (97, 448)  # 7

petridishDiameter = 275  # in px
...
while True:
    ...
    mask.fill(0)
    cv2.circle(mask, petridishCenter, petridishDiameter / 2, (255, 255, 255), -1)  # -1 fill the closed figure
    # cv2.imshow('mask', mask) #use for debugging
    ...
    angle_threshold = 100.0 / 180.0 * math.pi
    filter_value = 0.8
    ...
    limit_edge = 150 - droplet_diameter
